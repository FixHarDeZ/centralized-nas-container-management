...
| `torrentwatch/` | Scraper & Filter | 5059 / 15059 (HTTPS)| FastAPI + Volume `/data`. สแกน bearbit.org ตามช่วงเวลา (19:00-01:00 รันทุก 30 นาที / 01:00-06:00 หยุด / 06:00-19:00 รันทุก 60 นาที) โหลดเข้า `/downloads` ตรง. ลบประวัติเก่าเกิน 7 วัน ทุกวันอาทิตย์ 03:00. มี Endpoint `/api/status` แบบ Public |
