...
@pytest.mark.parametrize('harness', ['connection_harness.html', 'workspace_harness.html', 'quota_harness.html', 'starter_prompts_harness.html', 'coding_harness.html', 'terminal_layout_harness.html'])
