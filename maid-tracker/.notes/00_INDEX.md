...
- **(2026-08-18) `bank_name` / `bank_account`** บน `employees` — ใช้เมื่อ `payment_method='transfer'` เท่านั้น (ฟอร์มซ่อนช่องตอนเลือกเงินสด, หน้าจ่ายเงินเดือนโชว์เป็น alert). ไม่มี validation รูปแบบเลขบัญชี — ธนาคารไทยฟอร์แมตไม่เหมือนกัน
