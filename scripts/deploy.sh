...
ALL_STACKS=(secretary n8n news-feed torrentwatch homepage jellyfin maid-tracker portainer uptime-kuma watchtower hermes-agent friendly-reminder ink-reader dupe-sweeper ops-bot shorts-factory story-factory claude-desk)
