...
ALL_STACKS=(secretary news-feed torrentwatch my-secretary homepage jellyfin maid-tracker portainer uptime-kuma watchtower hermes-agent game-codes friendly-reminder)
